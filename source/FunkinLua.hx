	...
	public function new(script:String) {
		...
		try{
			...
			if(resultStr != null && result != 0) {
				trace('Error en los Scripts Lua! ' + resultStr);
				#if windows
				lime.app.Application.current.window.alert(resultStr, 'Error en los Scripts Lua!');
				#else
				luaTrace('Error cargando el Script Lua: "$script"\n' + resultStr, true, false, FlxColor.RED);
				#end
				lua = null;
				return;
			}
...
class ModchartText extends FlxText
{
	...
	public function new(x:Float, y:Float, text:String, width:Float)
	{
		...
		setFormat(Paths.font("Krabby Patty.ttf"), 16, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
...
class DebugLuaText extends FlxText
{
	...
	public function new(text:String, parentGroup:FlxTypedGroup<DebugLuaText>, color:FlxColor) {
		...
		setFormat(Paths.font("Krabby Patty.ttf"), 16, color, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		scrollFactor.set();
		borderSize = 1;
	}
