...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		changeModeText.setFormat(Paths.font("Krabby Patty.ttf"), 32, FlxColor.WHITE, CENTER);
	...
	function createTexts()
	{
		for (i in 0...4)
		{
			...
			text.setFormat(Paths.font("Krabby Patty.ttf"), 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	function reloadTexts()
	{
		for (i in 0...dumbTexts.length)
		{
			switch(i)
			{
				case 0: dumbTexts.members[i].text = 'Rating del Offset:';
				case 1: dumbTexts.members[i].text = '[' + ClientPrefs.comboOffset[0] + ', ' + ClientPrefs.comboOffset[1] + ']';
				case 2: dumbTexts.members[i].text = 'Numeros del Offset:';
	...
	function updateMode()
	{
		...
		if(onComboMenu)
			changeModeText.text = '< Combo Offset (Pressiona Aceptar Para Cambiar) >';
		else
			changeModeText.text = '< Note/Beat Delay (Presiona Aceptar Para Cambiar) >';
