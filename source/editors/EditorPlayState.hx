...
class EditorPlayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		scoreTxt = new FlxText(10, FlxG.height - 50, FlxG.width - 20, "Presionadas: 0 | Errores: 0", 20);
		...
		sectionTxt = new FlxText(10, 580, FlxG.width - 20, "Seccion: 0", 20);
		sectionTxt.setFormat(Paths.font("Krabby Patty.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		sectionTxt.scrollFactor.set();
		sectionTxt.borderSize = 1.25;
		add(sectionTxt);
		
		beatTxt = new FlxText(10, sectionTxt.y + 30, FlxG.width - 20, "Beat: 0", 20);
		beatTxt.setFormat(Paths.font("Krabby Patty.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		beatTxt.scrollFactor.set();
		beatTxt.borderSize = 1.25;
		add(beatTxt);

		stepTxt = new FlxText(10, beatTxt.y + 30, FlxG.width - 20, "Paso: 0", 20);
		stepTxt.setFormat(Paths.font("Krabby Patty.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		stepTxt.scrollFactor.set();
		stepTxt.borderSize = 1.25;
		add(stepTxt);

		var tipText:FlxText = new FlxText(10, FlxG.height - 24, 0, 'Presiona Esc para volver al editor de Charteo', 16);
		tipText.setFormat(Paths.font("Krabby Patty.ttf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	override function update(elapsed:Float) {
		...
		keyShit();
		scoreTxt.text = 'Presionadas: ' + songHits + ' | Errores: ' + songMisses;
		sectionTxt.text = 'Beat: ' + curSection;
		beatTxt.text = 'Beat: ' + curBeat;
		stepTxt.text = 'Paso: ' + curStep;
