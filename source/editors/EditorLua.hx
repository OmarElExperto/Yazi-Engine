...
class EditorLua {
	...
	public function new(script:String) {
		...
		if(resultStr != null && result != 0) {
			lime.app.Application.current.window.alert(resultStr, 'Error En el Script.lua!');
			trace('Error En El Script .lua! ' + resultStr);
			lua = null;
			return;
		}
		trace('Archivo Lua Cargado Exitosamente' + script);
