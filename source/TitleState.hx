	...
	override function update(elapsed:Float)
	{
		...
		if (initialized && !transitioning && skippedIntro)
		{
			...
			if(pressedEnter)
			{
				...
				FlxG.camera.flash(ClientPrefs.flashing ? FlxColor.WHITE : 0xFF00EEFF, 1);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['Mod Hecho por'], 15);
					#else
				...
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('Omar El Experto', 15);
					addMoreText('Digo', 15);
					addMoreText('Matris', 15);
					#else
				...
				case 6:
					#if PSYCH_WATERMARKS
					createCoolText(['La Peta Seta', 'Es'], -40);
					#else
					createCoolText(['La Peta Seta', 'Es'], -40);
					#end
				case 8:
				...
				// credTextShit.text += '\VS Pando';
				case 17:
						addMoreText('Yazi Engine'); // credTextShit.text += '\nYazi Engine';
